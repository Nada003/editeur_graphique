...
import ui.custom_graphics.ui_elements.UMLComponentParamPopup;  // corrigé ici

public class ClassAbstract extends ClassRender {

    public ClassAbstract(ClassModel model) {
        super(model);
    }
