...
public class IncludeRender extends UMLComponent implements DrawingSpecification {
    ...
    public void drawHead(Graphics2D graphics2D, Point... point) {
        ...
        // Texte <<extend>>
        drawLabel(graphics2D, "<<include>>", x1,x2 , y2);
    }


    @Override
    public Graphics2D lineStyle(Graphics2D g2d) {
        float[] dash = {10f, 10f};
        Stroke dashed = new BasicStroke(2, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 0, dash, 0);
